...
\centering
  ...
  \caption{Set up for data collection: the sensor unit is attached to a side surface of a bottle. The unit is connected to an android phone, where a data collection application runs.}
  \label{fig:set-up}
\end{figure}
\begin{figure}
\centering
  \includegraphics[width=0.3\linewidth]{water_empty.png}
  \includegraphics[width=0.3\linewidth]{water_half.png}
  \includegraphics[width=0.3\linewidth]{water_full.png}
  \caption{Spectrograms of impulse response recordings when the bottle is filled }
